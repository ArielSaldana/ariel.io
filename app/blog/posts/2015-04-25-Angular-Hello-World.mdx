...
summary: Introduction to AngularJS Developent. AngularJS extends the normal HTML syntax to express the application component more clearly giving HTML functionalities.
